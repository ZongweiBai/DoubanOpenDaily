...
public class VolleyErrorHelper {
    ...
    public static String getMessage(Object error) {
        if (error instanceof TimeoutError) {
            return BaseApplication.getContext().getResources().getString(R.string.server_down);
        } else if (isServerProblem(error)) {
//            return handleServerError(error, BaseApplication.getInstance());
            return BaseApplication.getContext().getResources().getString(R.string.server_error);
        } else if (isNetworkProblem(error)) {
            return BaseApplication.getContext().getResources().getString(R.string.no_internet);
        }
        return BaseApplication.getContext().getResources().getString(R.string.server_error);
    }
